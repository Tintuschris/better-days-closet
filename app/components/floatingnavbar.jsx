...
export default function FloatingNavBar({ activeIcon, setActiveIcon, isVisible }) {
  ...
  return (
    <>
      <nav
        className={`fixed text-primarycolor bottom-0 left-0 w-full bg-white shadow-lg border-t p-4 flex justify-around transition-transform duration-300 ${isVisible ? 'translate-y-0' : 'translate-y-full'
          }`}
      >
        {/* Home Icon and Text */}
