        ...
        <div className="flex items-center justify-between max-w-md mx-auto">
          ...
          >
            <div className={`w-5 h-5 rounded-full border-2 transition-all duration-300 ${
              currentIndex >= 0 ? 'bg-primarycolor border-primarycolor' : 'border-gray-300'
            }`} />
          ...
          >
            <div className={`w-5 h-5 rounded-full border-2 transition-all duration-300 ${
              currentIndex >= 1 ? 'bg-primarycolor border-primarycolor' : 'border-gray-300'
            }`} />
            <span className={`text-xs mt-1 transition-colors duration-300 ${
          ...
          >
            <div className={`w-5 h-5 rounded-full border-2 transition-all duration-300 ${
              currentIndex >= 2 ? 'bg-primarycolor border-primarycolor' : 'border-gray-300'
            }`} />
            <span className={`text-xs mt-1 transition-colors duration-300 ${
  ...
  const handleOrderConfirmation = async () => {
    ...
    <div className="min-h-screen bg-white overflow-hidden">
        ...
        {!isLoading && currentStep !== 'payment' && (
          <div className="fixed bottom-0 left-0 right-0 bg-white p-4 shadow-lg transition-transform duration-300 ease-out">
            <button
